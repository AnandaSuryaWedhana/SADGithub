...
<body>
  @include('partials.partialnavbar')
    ...
    <form action="/updateproduk/{{ $data->ID_PRODUK }}" method="post">
        @csrf
        <div class="col-12" style="padding-top: 10px">
        <label for="inputKategori" class="form-label">Nama Kategori : </label>
            <select name="Kategori" id="inputKategori">
              <option hidden value="{{$data->kategori->ID_KATEGORI}}">{{$data->kategori->NAMA_KATEGORI}}</option>
              @foreach($kategori[0] as $kat)
      ...
      <div class="col-12" style="padding-top: 10px">
        ...
        <input type="text" name="NamaProduk" class="form-control" id="inputNamaProduk" placeholder="" value="{{ $data->NAMA_PRODUK}}" />
      ...
      <div class="col-12" style="padding-top: 10px">
        ...
        <input type="text" name="DeskripsiProduk" class="form-control" id="inputDeskripsiProduk" placeholder="" value="{{ $data->DESKRIPSI_PRODUK}}" />
      ...
      <div class="col-12" style="padding-top: 10px">
        ...
        <input type="number" name="HargaProduk" class="form-control" id="inputHargaProduk" placeholder="" value="{{ $data->HARGA_PRODUK}}" />
      ...
      <div class="col-12" style="padding-top: 10px">
        ...
        <input type="number" name="JumlahProduk" class="form-control" id="inputJumlahProduk" placeholder="" value="{{ $data->JUMLAHPRODUK_TRANSAKSI}}" />
